...
\newpage
\bibliography{tese} 	% Use the tese.bib file for the bibliography
%\bibliographystyle{unsrt} 		% Use the plainnat style of referencing

% Place the style in the directory of the thesis
% curl -O https://golem.ph.utexas.edu/~distler/TeXstuff/utphys.bst
